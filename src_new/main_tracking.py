...
def main():
    ...
    out = cv2.VideoWriter('/home/neosai/Documents/projects/deep_face_recognition/video/1_03.avi', fourcc, 15, (w, h))
    ...
    tracker = Tracker(iou_thresh=0.3, max_frames_to_skip=30, max_trace_length=5, trackIdCount=0)
